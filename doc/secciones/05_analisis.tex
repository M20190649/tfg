...
\begin{itemize}
  ...
  \item Escalado: Debido a su ligereza el arranque de los contenedores es muy rápido en comparación a los sistemas tradicionales, podemos desplegar nuevas replicas en unos segundo si la demanda sube y volverlas a destruir cuando ya no son necesarias.
